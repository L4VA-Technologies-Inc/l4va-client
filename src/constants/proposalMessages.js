...
export const PROPOSAL_EXECUTION_MESSAGES = {
  ...
  inProgress: {
    ...
    stake_assets: 'Staking transactions are being prepared and executed...',
    unstake_assets: 'Unstaking transactions are being prepared and executed...',
    harvest_rewards: 'Reward harvesting transactions are being prepared and executed...',
  ...
  success: {
    ...
    stake_assets: 'Assets have been successfully staked. Rewards will accumulate over time.',
    unstake_assets: 'Assets have been successfully unstaked and rewards transferred to treasury.',
    harvest_rewards: 'Rewards have been successfully harvested and transferred to treasury.',
    termination: {

    ...
    <div className="grid grid-cols-2 gap-8 rounded-b-[10px] bg-input-bg pt-4 pb-8 px-16">
      <div className="space-y-10">
        ...
        <div>
          ...
          <p className="text-[20px]">
            {data.investmentWindowOpenTime || 'Not specified'}
          </p>
        </div>
      </div>
      <div className="space-y-10">
        <div>
          ...
          <p className="text-[20px]">
            {data.percentAssetsOffered ? `${data.percentAssetsOffered}%` : 'Not specified'}
          </p>
        </div>
        <div>
          <p className="uppercase font-semibold text-dark-100">
        ...
        <div>
          ...
          <p className="text-[20px]">
            {data.ftInvestmentReserve || 'Not specified'}
          </p>
        </div>
        <div>
          <p className="uppercase font-semibold text-dark-100">
          ...
          <p className="text-[20px]">
            {data.percentLiquidityPoolContribution ? `${data.percentLiquidityPoolContribution}%` : 'Not specified'}
          </p>
        </div>
      </div>
    </div>

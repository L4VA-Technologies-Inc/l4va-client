...
export const Pagination = ({
  ...
  const buttonBaseClasses = "flex items-center justify-center w-10 h-10 text-sm font-medium transition-all duration-200 rounded-lg border";
  const activeClasses = "bg-orange-500 text-white border-orange-500 shadow-lg";
  const inactiveClasses = "bg-gray-800 text-gray-300 border-gray-700 hover:bg-gray-700 hover:text-white hover:border-gray-600";
          ...
          {showFirstPage && (
            <>
              <button
                ...
                className={clsx(
                  buttonBaseClasses,
                  currentPage === 1 ? activeClasses : inactiveClasses
                )}
              >
                1
              </button>
          ...
          {showLastPage && (
            <>
              ...
              <button
                ...
                className={clsx(
                  buttonBaseClasses,
                  currentPage === totalPages ? activeClasses : inactiveClasses
                )}
              >
                {totalPages}
              </button>

...
export const DeletePresetConfirmModal = ({ isOpen = true, onClose, onConfirm, presetName }) => {
  ...
  return (
    <ModalWrapper isOpen={isOpen} onClose={handleClose} title="Delete preset" size="md">
      <div className="flex flex-col gap-4">
        <p className="text-white/80">
          Are you sure you want to delete the preset <span className="font-semibold text-white">{presetName}</span>?
        </p>

...
export const DeleteProposalConfirmModal = ({ isOpen = true, onClose, onConfirm, proposalTitle = 'this proposal' }) => {
  ...
  return (
    <ModalWrapper isOpen={isOpen} onClose={handleClose} title="Delete proposal" size="md">
      <div className="flex flex-col gap-4">
        <p className="text-white/80">
          Are you sure you want to delete the proposal <span className="font-semibold text-white">{proposalTitle}</span>
          ?
        </p>
